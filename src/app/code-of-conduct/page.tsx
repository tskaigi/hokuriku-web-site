  ...
  return (
    <main className="bg-blue-light-100 font-noto py-10 pt-16 md:px-8">
      ...
      <div className="mx-auto flex max-w-screen-xl flex-col gap-6 bg-white p-6 text-lg md:rounded-xl lg:p-10">
        <section>
          <p>
            TSKaigi に参加するすべての人は下記の行動規範を守ることを求められます。主催者はこの行動規範をカンファレンス、パーティ、交流会に適用します。すべての人にとって安全な場所を提供するため、聴講者、登壇者、スポンサー、主催スタッフ含めたすべての参加者にご協力をお願いします。
          </p>
        </section>
        <section>
          <p>
        ...
        <section>
          <p>
            トラブルを最小限に抑えるため
            <span className="font-bold text-orange-500">絶対に個人で対応しないでください。</span>
